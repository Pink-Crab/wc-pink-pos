...
class App_Factory
{
    ...
    {
        $this->app = new \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App();
    }
    /**
    ...
    public function with_wp_dice(bool $include_default_rules = \false) : self
    {
        ...
        // Setup DI Container
        $container = \pc_pink_pos_0_0_1\PinkCrab\Perique\Services\Dice\PinkCrab_Dice::withDice(new \pc_pink_pos_0_0_1\Dice\Dice());
        ...
        $this->app->set_registration_services(new \pc_pink_pos_0_0_1\PinkCrab\Perique\Services\Registration\Registration_Service());
        $this->app->set_loader($loader);
        // Include Hookable.
        $this->app->registration_middleware(new \pc_pink_pos_0_0_1\PinkCrab\Perique\Services\Registration\Middleware\Hookable_Middleware($loader));
        return $this;
    }
    /**
    ...
    {
        return array('*' => array('substitutions' => array(\pc_pink_pos_0_0_1\PinkCrab\Perique\Interfaces\Renderable::class => new \pc_pink_pos_0_0_1\PinkCrab\Perique\Services\View\PHP_Engine(__DIR__), \wpdb::class => $GLOBALS['wpdb'])));
    }
    /**
     * Set the DI rules
     *
    ...
    {
        $this->app->container_config(function (\pc_pink_pos_0_0_1\PinkCrab\Perique\Interfaces\DI_Container $container) use($rules) : void {
     ...
     */
    public function app() : \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App
    {
        return $this->app;
    }
    /**
     ...
     * @return \PinkCrab\Perique\Application\App
     */
    public function boot() : \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App
    {
