...
class Test_Hookable_Middleware extends \WP_UnitTestCase
{
    ...
    public function test_can_be_constructed_with_loader() : void
    {
        ...
        $hookable = new \pc_pink_pos_0_0_1\PinkCrab\Perique\Services\Registration\Middleware\Hookable_Middleware($loader);
        $this->assertSame($loader, \pc_pink_pos_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($hookable, 'loader'));
    }
    ...
    public function test_only_processes_classes_that_implement_hookable() : void
    {
        ...
        $hookable->process(new \pc_pink_pos_0_0_1\PinkCrab\Perique\Tests\Fixtures\Mock_Objects\Hookable\Hookable_Mock());
        // Process none hookable class
        $hookable->process(new \pc_pink_pos_0_0_1\PinkCrab\Perique\Tests\Fixtures\Mock_Objects\Sample_Class());
