...
trait App_Helper_Trait
{
    ...
    protected static function unset_app_instance() : void
    {
        ...
        \pc_pink_pos_0_0_1\Gin0115\WPUnit_Helpers\Objects::set_property($app, 'app_config', null);
        \pc_pink_pos_0_0_1\Gin0115\WPUnit_Helpers\Objects::set_property($app, 'container', null);
        \pc_pink_pos_0_0_1\Gin0115\WPUnit_Helpers\Objects::set_property($app, 'registration', null);
        \pc_pink_pos_0_0_1\Gin0115\WPUnit_Helpers\Objects::set_property($app, 'loader', null);
        \pc_pink_pos_0_0_1\Gin0115\WPUnit_Helpers\Objects::set_property($app, 'booted', \false);
        $app = null;
    }
    /**
     ...
     * @return App
     */
    protected function pre_populated_app_provider() : \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App
    {
