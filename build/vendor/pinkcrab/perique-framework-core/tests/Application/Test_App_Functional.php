...
class Test_App_Functional extends \WP_UnitTestCase
{
    ...
    public function test_all_hooks_fire_on_finalise_during_boot() : void
    {
        ...
        \add_action(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Hooks::APP_INIT_PRE_BOOT, function (\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config $config, \pc_pink_pos_0_0_1\PinkCrab\Loader\Hook_Loader $loader, \pc_pink_pos_0_0_1\PinkCrab\Perique\Interfaces\DI_Container $container) {
            echo 'Pre Boot Hook';
        }, 10, 3);
        // Pre registration hook.
        $this->expectOutputRegex('/Pre Registration Hook/');
        \add_action(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Hooks::APP_INIT_PRE_REGISTRATION, function (\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config $config, \pc_pink_pos_0_0_1\PinkCrab\Loader\Hook_Loader $loader, \pc_pink_pos_0_0_1\PinkCrab\Perique\Interfaces\DI_Container $container) {
            echo 'Pre Registration Hook';
        }, 10, 3);
        // Post registration.
        $this->expectOutputRegex('/Post Registration Hook/');
        \add_action(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Hooks::APP_INIT_POST_REGISTRATION, function (\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config $config, \pc_pink_pos_0_0_1\PinkCrab\Loader\Hook_Loader $loader, \pc_pink_pos_0_0_1\PinkCrab\Perique\Interfaces\DI_Container $container) {
        ...
        do_action('init');
        // Cleanup
        remove_all_actions(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Hooks::APP_INIT_PRE_BOOT);
        remove_all_actions(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Hooks::APP_INIT_PRE_REGISTRATION);
        remove_all_actions(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Hooks::APP_INIT_POST_REGISTRATION);
    }
    ...
    public function test_can_use_static_make_method_to_use_di_container() : void
    {
        ...
        $parent = \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App::make(\pc_pink_pos_0_0_1\PinkCrab\Perique\Tests\Fixtures\Mock_Objects\Parent_Dependency::class);
        $this->assertInstanceOf(\pc_pink_pos_0_0_1\PinkCrab\Perique\Tests\Fixtures\Mock_Objects\Parent_Dependency::class, $parent);
        $this->assertInstanceOf(\pc_pink_pos_0_0_1\PinkCrab\Perique\Tests\Fixtures\Mock_Objects\Sample_Class::class, $parent->get_sample_class());
    }
    ...
    public function test_cant_use_make_before_app_booted() : void
    {
        ...
        \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App::make(\pc_pink_pos_0_0_1\PinkCrab\Perique\Tests\Fixtures\Mock_Objects\Parent_Dependency::class);
    }
    ...
    {
        $app = $this->pre_populated_app_provider()->boot();
        $version = \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App::config('version');
    ...
    public function test_cant_use_config_before_app_has_been_booted() : void
    {
        $this->expectException(\pc_pink_pos_0_0_1\PinkCrab\Perique\Exceptions\App_Initialization_Exception::class);
        $this->expectExceptionCode(4);
        \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App::config('version');
    }
    ...
    public function test_can_user_static_view_from_app_once_booted() : void
    {
        $app = $this->pre_populated_app_provider()->container_config(function ($di) {
            $di->addRules(['*' => array('substitutions' => array(\pc_pink_pos_0_0_1\PinkCrab\Perique\Interfaces\Renderable::class => new \pc_pink_pos_0_0_1\PinkCrab\Perique\Services\View\PHP_Engine(FIXTURES_PATH . '/Views')))]);
        })->boot();
        $this->expectOutputString('HI');
        \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App::view()->render('hello', ['hello' => 'HI']);
    }
    ...
    public function test_debugInfo_dumps_static_properties_values() : void
    {
        ...
        $this->assertInstanceOf(\pc_pink_pos_0_0_1\PinkCrab\Perique\Interfaces\DI_Container::class, $debug['container']);
        $this->assertArrayHasKey('app_config', $debug);
        $this->assertInstanceOf(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config::class, $debug['app_config']);
