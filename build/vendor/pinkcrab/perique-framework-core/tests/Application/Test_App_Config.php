...
class Test_App_Config extends \WP_UnitTestCase
{
    ...
    public function test_can_create() : void
    {
        ...
        $this->assertInstanceOf(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config::class, new \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config(self::SAMPLE_SETTINGS));
        // Without additional settings
        $this->assertInstanceOf(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config::class, new \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config());
    }
    /**
    ...
    {
        $this->assertTrue(\is_string(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Config::namespace('rest')));
        $this->assertTrue(\is_array(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Config::path()));
        $this->assertTrue(\is_array(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\Config::url()));
    }
    /**
    ...
    {
        $app_config = new \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config(self::SAMPLE_SETTINGS);
    ...
    {
        $no_override = \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App::make(\pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config::class);
        $with_override = new \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config(self::SAMPLE_SETTINGS);
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config(array('post_types' => array('inv_cpt' => \false)));
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \pc_pink_pos_0_0_1\PinkCrab\Perique\Application\App_Config(array('meta' => array('invalid' => array('slug' => 'my_cpt'))));
    }
