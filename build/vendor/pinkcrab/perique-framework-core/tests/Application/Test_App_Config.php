...
class Test_App_Config extends \WP_UnitTestCase
{
     ...
     */
    public const SAMPLE_SETTINGS = array('additional' => array('array' => array(1, 2, 3, 4), 'string' => 'HI'), 'namespaces' => array('rest' => 'fake_rest'), 'post_types' => array('my_cpt' => 'my_slug'), 'taxonomies' => array('tax' => 'my_slug'), 'db_tables' => array('db' => 'db_table'), 'meta' => array('post' => array('post_meta_1' => 'One Post'), 'user' => array('user_meta_1' => 'One User'), 'term' => array('term_meta_1' => 'One Term')));
    /**
    ...
    public function test_can_create() : void
    {
        ...
        $this->assertInstanceOf(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config::class, new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config(self::SAMPLE_SETTINGS));
        // Without additional settings
        $this->assertInstanceOf(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config::class, new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config());
    }
    /**
    ...
    {
        $this->assertTrue(\is_string(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\Config::namespace('rest')));
        $this->assertTrue(\is_array(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\Config::path()));
        $this->assertTrue(\is_array(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\Config::url()));
    }
    /**
    ...
    {
        $app_config = new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config(self::SAMPLE_SETTINGS);
    ...
    {
        $no_override = \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App::make(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config::class);
        $with_override = new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config(self::SAMPLE_SETTINGS);
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config(array('post_types' => array('inv_cpt' => \false)));
    ...
    {
        $this->expectException(\OutOfBoundsException::class);
        $app_config = new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config(array('meta' => array('invalid' => array('slug' => 'my_cpt'))));
    }
