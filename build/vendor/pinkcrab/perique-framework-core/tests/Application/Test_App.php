...
use pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\Config;
...
use pinkcrab_cccp_0_0_1\PinkCrab\Perique\Tests\Application\Test_App_Config;
...
class Test_App extends \WP_UnitTestCase
{
    ...
    public function test_set_container() : void
    {
        ...
        $this->assertSame($container, \pinkcrab_cccp_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($app, 'container'));
    }
    ...
    public function test_set_app_config() : void
    {
        ...
        $this->assertInstanceOf(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App_Config::class, \pinkcrab_cccp_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($app, 'app_config'));
    }
    ...
    {
        $app = new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App();
        $registration = $this->createMock(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Services\Registration\Registration_Service::class);
        $app->set_registration_services($registration);
        $this->assertSame($registration, \pinkcrab_cccp_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($app, 'registration'));
    }
    ...
    {
        $app = new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\App();
        $loader = $this->createMock(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Loader::class);
        $app->set_loader($loader);
        $this->assertSame($loader, \pinkcrab_cccp_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($app, 'loader'));
    }
    ...
    public function test_container_config() : void
    {
        ...
        $container = $this->createMock(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Interfaces\DI_Container::class);
        $app->set_container($container);
        $app->container_config(function (\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Interfaces\DI_Container $container) : void {
            $this->assertInstanceOf(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Interfaces\DI_Container::class, $container);
        });
    }
    ...
    public function test_registration_middleware() : void
    {
        ...
        $middleware = $this->createMock(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Interfaces\Registration_Middleware::class);
        $app->set_registration_services($registration);
        $app->registration_middleware($middleware);
        $this->assertContains($middleware, \pinkcrab_cccp_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($registration, 'middleware'));
    }
    ...
    public function test_registration_classes() : void
    {
        ...
        $registration = new \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Services\Registration\Registration_Service();
        $app->set_registration_services($registration);
        $app->registration_classes(array(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Tests\Application\Sample_Class::class));
        $this->assertContains(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Tests\Application\Sample_Class::class, \pinkcrab_cccp_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($registration, 'class_list'));
    }
    ...
    public function test_boot() : void
    {
        ...
        $this->assertInstanceOf(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Interfaces\DI_Container::class, \pinkcrab_cccp_0_0_1\Gin0115\WPUnit_Helpers\Objects::get_property($registration, 'di_container'));
    }
    ...
    {
        $app = $this->pre_populated_app_provider();
        $this->assertInstanceOf(\pinkcrab_cccp_0_0_1\PinkCrab\Perique\Interfaces\DI_Container::class, $app->get_container());
    }
    ...
    public function test_config_facade() : void
    {
        $app = $this->pre_populated_app_provider();
        $app->boot();
        $this->assertEquals(FIXTURES_PATH . '/Views/', \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\Config::path('view'));
        $this->assertEquals('test_value', \pinkcrab_cccp_0_0_1\PinkCrab\Perique\Application\Config::additional('test_key'));
    }
}
