 ...
 */
namespace pinkcrab_cccp_0_0_1\PinkCrab\Loader\Tests\Intergration;
...
class Test_Hook_Manager_Intergration extends \WP_UnitTestCase
{
    ...
    {
        // Hooks
        $global = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('global', 'is_string');
        $admin = (new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('admin', 'is_string'))->front(\false);
        // Front & Admin true by default.
        $front = (new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('front', 'is_string'))->admin(\false);
        // Front
        $manager_front = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_Object_Mock();
        ...
        $manager_admin = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Tests\Fixtures\Hook_Manager_Object_Mock();
    ...
    {
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_action', 'is_string');
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
    ...
    {
        $this->expectException(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_action', 'no_Callback_HERE');
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_filter', 'is_string');
        $hook->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::FILTER);
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    ...
    {
        $this->expectException(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_filter', 'no_Callback_HERE');
        $hook->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::FILTER);
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    public function test_can_remove_hook() : void
    {
        ...
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('remove_me_action', 'is_string');
        $hook->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::REMOVE);
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    ...
    {
        $this->expectException(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('remove_me_action', 'no_Callback_HERE');
        $hook->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::REMOVE);
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $hook_both = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_ajax_both', 'is_string');
        $hook_both->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::AJAX);
        $hook_public_only = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_ajax_public', 'is_string');
        $hook_public_only->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::AJAX);
        $hook_public_only->ajax_private(\false);
        $hook_private_only = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_ajax_private', 'is_string');
        $hook_private_only->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::AJAX);
        $hook_private_only->ajax_public(\false);
        $hook_neither = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_ajax_neither', 'is_string');
        $hook_neither->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::AJAX);
    ...
    public function test_throws_exception_with_invlalid_ajax_callback() : void
    {
        $this->expectException(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('remove_me_action', 'no_Callback_HERE');
        $hook->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::AJAX);
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
    ...
    {
        $shortcode = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_shortcode', 'is_string');
        $shortcode->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::SHORTCODE);
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
    ...
    {
        $this->expectException(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Exceptions\Invalid_Hook_Callback_Exception::class);
        $hook = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook('my_shortcode', 'no_Callback_HERE');
        $hook->type(\pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook::SHORTCODE);
        $manager = new \pinkcrab_cccp_0_0_1\PinkCrab\Loader\Hook_Manager();
        $manager->process_hook($hook);
    }
