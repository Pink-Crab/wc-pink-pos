...
use pinkcrab_cccp_0_0_1\PinkCrab\Collection\Tests\Fixtures\Array_Collection;
class Test_Has_ArrayAccess extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $collection = new \pinkcrab_cccp_0_0_1\PinkCrab\Collection\Tests\Fixtures\Array_Collection();
        $collection[] = '0';
        $collection[1] = '1';
    ...
    {
        $collection = new \pinkcrab_cccp_0_0_1\PinkCrab\Collection\Tests\Fixtures\Array_Collection(array('one', 'two'));
    ...
    {
        $collection = new \pinkcrab_cccp_0_0_1\PinkCrab\Collection\Tests\Fixtures\Array_Collection(array('test'));
